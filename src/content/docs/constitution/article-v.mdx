...
Information Sovereignty applies the core logic of [Article I — Bounded Capability](../article-i)
to data specifically — information access is a capability like any other, and
the same default-deny posture applies. It depends on [Article VII — Auditability](../article-vii)
...
And it connects to [Article VI — Governance Transparency](../article-vi): data classification
