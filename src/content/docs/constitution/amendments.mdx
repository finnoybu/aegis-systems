...
|---------|--------|------|---------|
| v0.1.0 | Archived — superseded by v0.1.1 | 2026-03-05 | Initial eight-article constitution |
| v0.1.1 | Archived — superseded by v0.2.0 for new citations | 2026-03-19 | Canonical snapshot of eight-article constitution; cited in NIST AI RMF submission ([doi:10.5281/zenodo.19112564](https://doi.org/10.5281/zenodo.19112564)) |
| v0.2.0 | Current | 2026-03-21 | Eleven articles; four renamed (II, IV, V, VIII); three added (IX, X, XI); constitutional register adopted |

---

## Backward Compatibility

v0.1.0 and v0.1.1 remain the versions of record for documents citing them
prior to 2026-03-21, including the NIST AI RMF position statement submitted
March 7, 2026 (which cites v0.1.1). Those citations are valid and unaffected
by this revision. v0.2.0 is the canonical version for all new citations from
this date forward.
