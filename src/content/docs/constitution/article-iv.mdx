...
Human Oversight depends on [Article XI — Escalation Discipline](../article-xi) — the procedural
requirements for how escalation is requested, approved, and documented.
It depends on [Article II — Authority Binding](../article-ii) — the human reviewer's authority
level must be verified before their approval is accepted. And it connects to
[Article VII — Auditability](../article-vii): every escalation event, including timeouts and
