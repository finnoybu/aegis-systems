...
Deny by Default is the posture from which every other article operates.
[Article I — Bounded Capability](../article-i) denies undefined capabilities before evaluation begins.
[Article II — Authority Binding](../article-ii) denies unbound execution at the gateway. [Article VII — Auditability](../article-vii) makes unavailable audit a precondition failure — not a logged gap,
but a denial. [Article XI — Escalation Discipline](../article-xi) applies the same logic to
